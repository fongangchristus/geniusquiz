...
describe('Service Tests', () => {
  describe('Notification Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Notification(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 'AAAAAAA', TypeNotification.SMS);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dateNotif: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
