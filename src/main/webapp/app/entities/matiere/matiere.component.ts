...
export class MatiereComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.matiereService
      ...
      .subscribe(
        (res: HttpResponse<IMatiere[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMatieres(): void {
    this.eventSubscriber = this.eventManager.subscribe('matiereListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMatiere[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
