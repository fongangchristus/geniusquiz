...
export class CursusComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.cursusService
      ...
      .subscribe(
        (res: HttpResponse<ICursus[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCursuses(): void {
    this.eventSubscriber = this.eventManager.subscribe('cursusListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICursus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
