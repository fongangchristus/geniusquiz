...
export class ClasseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.classeService
      ...
      .subscribe(
        (res: HttpResponse<IClasse[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInClasses(): void {
    this.eventSubscriber = this.eventManager.subscribe('classeListModification', () => this.loadPage());
  }
